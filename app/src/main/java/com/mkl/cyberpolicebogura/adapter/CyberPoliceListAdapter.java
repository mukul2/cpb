...
public class CyberPoliceListAdapter extends RecyclerView.Adapter<CyberPoliceListAdapter.MyViewHolder> {
    ...
    public CyberPoliceListAdapter(Context context, List<Police> contactList) {
...
//https://gl-images.condecdn.net/image/lN39xbMKeop/crop/405/f/Gal-Gadot-1.jpg
    ...
    public void onBindViewHolder(MyViewHolder holder, final int position) {
        ...
        holder.tv_body.setText("Open Profile");
